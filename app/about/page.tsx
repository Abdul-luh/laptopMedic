      ...
      <header className="relative z-10 px-4 py-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="/about" className="text-blue-800 font-medium">About</a>
            <a href="/contact" className="text-blue-600 font-medium hover:text-blue-700 transition-colors">Contact</a>
            <a href="/login" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">Get Started</a>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Your trusted AI-powered laptop diagnostic and repair platform, providing instant solutions 
              and connecting you with certified technicians when you need expert help.
            </p>
          </section>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                    We believe that technology should work seamlessly for everyone. Our mission is to make 
                    laptop troubleshooting accessible, fast, and reliable through cutting-edge AI technology 
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <p className="text-gray-700">Instant AI-powered diagnostics for common issues</p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                        <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <p className="text-gray-700">Step-by-step repair guides for all skill levels</p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                        <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <p className="text-gray-700">Direct connection to certified repair technicians</p>
                    </div>
                  </div>
                </div>
          ...
          {/* Features Grid */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Why Choose Laptop Medic?</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">AI-Powered Diagnostics</h3>
                <p className="text-gray-600 leading-relaxed">
                  Get instant diagnosis of your laptop issues with our advanced AI system that analyzes 
                  symptoms and provides accurate solutions in seconds.
                </p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Connect with certified laptop repair technicians in your area when you need 
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Our AI diagnostic system is available round the clock, ensuring you can get 
                  help whenever laptop issues strike.
                </p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">Easy-to-Follow Solutions</h3>
                <p className="text-gray-600 leading-relaxed">
                  Receive step-by-step repair instructions with difficulty ratings and estimated 
                  completion times tailored to your skill level.
                </p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Save money on unnecessary repairs with accurate diagnostics and DIY solutions 
                  for issues you can fix yourself.
                </p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Access solutions for all major laptop brands and models, from common issues 
                  to complex hardware problems.
                </p>
              </div>
          ...
          <section className="text-center">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 lg:p-12 shadow-xl">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready to Fix Your Laptop?</h2>
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                Join thousands of satisfied users who have successfully diagnosed and repaired 
                their laptops with our AI-powered platform.
              </p>
